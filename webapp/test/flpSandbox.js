		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Revaluation Reconciliation Report",
									"targetURL": "#zfizfirevalrecon-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfizfirevalrecon-display": {
								"semanticObject": "zfizfirevalrecon",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfi.zfirevalrecon",
									"url": sap.ui.require.toUrl("zfi/zfirevalrecon")
								}
							}
						}
					}
